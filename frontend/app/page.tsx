  ...
  return (
    <div className="bg-white overflow-x-clip">
      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="pt-24 pb-0 lg:pb-12 min-h-[calc(100vh-80px)] flex flex-col justify-end relative">
            <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 relative z-10 pb-12 sm:pb-16">
                {/* Floating Left Card explicitly matching QuintoAndar dimensions (Narrow Vertical Rectangle) */}
                <div className="bg-white rounded-[2rem] p-8 sm:p-10 max-w-[440px] shadow-2xl animate-in slide-in-from-left-8 duration-700">
                    ...
                    {/* QuintoAndar-style Sub-tabs (Alugar | Comprar) to force vertical height */}
