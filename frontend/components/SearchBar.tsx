           ...
           <div className="relative group">
            ...
            <div className="relative">
                ...
                <select 
                  ...
                  disabled
                  className="block w-full rounded-xl border-0 bg-gray-50 py-3 pl-10 pr-8 text-gray-900 font-semibold ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary sm:text-sm sm:leading-6 transition-all cursor-default appearance-none"
                >
