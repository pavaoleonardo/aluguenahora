...
export default function PropertyDetailClient({ id }: { id: string }) {
  ...
  return (
    <div className="bg-white">
      {/* Ful-Screen Carousel Area */}
      <div className="w-full border-b border-gray-200 bg-[#f9f9f9]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div className="flex flex-col lg:flex-row lg:gap-x-12">
          {/* Left Column (Content) */}
          <div className="flex-1 flex col mt-0">
          ...
          {/* Virtual Right Column for balance (Empty for now, perfect for future contact form) */}
